...
--------------------------------------------------------------------------------
#2.  Find the names of actors who have acted in more than 10 films. using CTE
WITH actor_films AS (
SELECT actor_id, 
...
FROM sakila.payment);
-------------------------------------------------------------------------------------------------------
# 4.List all films whose rental rate is higher than the average rental rate of all films. Using Subquery 
...
FROM sakila.film );
------------------------------------------------------------------------------------
#5.List the titles of films that were never rented. Using View 
...
----------------------------------------------------------------------------------
#6.Display the customers who rented films in the same month as customer with ID 5. Using CTE
...
----------------------------------------------------------------------------------------------------
#7.Find all staff members who handled a payment greater than the average payment amount. using Subquery 
...
---------------------------------------------------------------------------------------------
#9. Find all customers who have the same address as customer with ID 1  using subquery
